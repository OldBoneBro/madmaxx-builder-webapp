...
export default function FooterStyle16 () {

    return (

        <div className="flex w-[90rem] p-[2.5rem_5rem_5rem_5rem] flex-col items-center gap-10">
            <div className="flex justify-between items-start self-stretch">
                <Logo />
                <div className="flex items-start">
                    <ul className="flex w-[10rem] flex-col items-start">
                        <ol className="flex px-5 py-4 justify-center items-center gap-2 rounded-2xl"><a href="/" className="text-[#757575] font-inter text-base not-italic font-semibold tracking-[-.02rem]">Link</a></ol>
