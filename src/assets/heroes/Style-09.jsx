        ...
        <div className="flex flex-col w-[90rem] items-start">
            ...
            <div className="flex w-full px-[19.5rem] py-24 flex-col items-center gap-20">
                ...
                <div className=" relative flex w-[57.6875rem] h-[25.6875rem] items-center">
                    ...
                    <div className="absolute left-24 flex w-[45.6875rem] h-[25.6875rem] justify-center items-center rounded-[2.5rem] dark:bg-white bg-[#404040]">
                        <div className="flex justify-center items-center w-[6.5rem] h-[6.5rem] rounded-full bg-gradient-135  from-[#00EA87] to-[#78CBFF] hover:from-[#4510ca] hover:to-[#4510ca]">
                            <PlaySvg width="44.373" height="44.373" />
                        </div>
                    </div>
                    <div className="w-[34.25rem] h-[19.25rem] rounded-[2.5rem] bg-[#1F1F1F]"></div>
                </div>
