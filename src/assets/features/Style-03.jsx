...
export default function FeatureStyle03 () {
        ...
        <div className="flex w-[90rem] p-20 items-center gap-[7.5rem] ">
            <div className="flex flex-col items-start gap-16 flex-[1_0_0]">
                <div className="flex flex-col items-start gap-10">
                    <p className="w-[38.75rem] dark:text-white text-[#404040] font-inter text-[3.25rem]/[4rem] not-italic font-semibold tracking-[-0.1625rem]">Build your landings in minutes</p>
